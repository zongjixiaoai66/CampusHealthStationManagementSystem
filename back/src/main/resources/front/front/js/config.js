...
var centerMenu = [
    ...
    ,{
        name: '每日健康填报',
        url: '../jiankangtianbao/list.html'
    }
    ,{
        name: '驿站收藏',
        url: '../jiankangyizhanCollection/list.html'
    }
    ,{
        name: '驿站留言',
        url: '../jiankangyizhanLiuyan/list.html'
    }
    ,{
        name: '服务收藏',
        url: '../tijianCollection/list.html'
    }
    ,{
        name: '服务留言',
        url: '../tijianLiuyan/list.html'
    }
    ,{
        name: '体检预约',
        url: '../tijianYuyue/list.html'
    }
    ,{
        name: '学生请假',
        url: '../yonghuqingjia/list.html'
    }
    ,{
        name: '自测异常信息',
        url: '../ziceyichang/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '健康驿站',
        url: './pages/jiankangyizhan/list.html'
    },
    {
        name: '校园健康资讯',
    ...
    {
        name: '体检服务',
        url: './pages/tijian/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xiaoyuanjiankangyz/admin/dist/index.html#/login";
