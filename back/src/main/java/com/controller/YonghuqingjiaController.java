...
//        else if("学生".equals(role))
//            yonghuqingjia.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(yonghuqingjia.getYonghuqingjiaText()) || "null".equals(yonghuqingjia.getYonghuqingjiaText())){
                yonghuqingjia.setYonghuqingjiaText(null);
        }
        if("".equals(yonghuqingjia.getYonghuqingjiaYesnoText()) || "null".equals(yonghuqingjia.getYonghuqingjiaYesnoText())){
                yonghuqingjia.setYonghuqingjiaYesnoText(null);
        }
