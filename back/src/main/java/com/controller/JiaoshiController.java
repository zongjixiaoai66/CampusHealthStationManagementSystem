...
//                            jiaoshiEntity.setDataDelete(1);//逻辑删除字段
...
//                            jiaoshiEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //账户
                        List<JiaoshiEntity> jiaoshiEntities_username = jiaoshiService.selectList(new EntityWrapper<JiaoshiEntity>().in("username", seachFields.get("username")).eq("data_delete", 1));
                        if(jiaoshiEntities_username.size() >0 ){
                         ...
                         //教师手机号
                        List<JiaoshiEntity> jiaoshiEntities_jiaoshiPhone = jiaoshiService.selectList(new EntityWrapper<JiaoshiEntity>().in("jiaoshi_phone", seachFields.get("jiaoshiPhone")).eq("data_delete", 1));
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        else if(jiaoshi.getDataDelete() != 1)
