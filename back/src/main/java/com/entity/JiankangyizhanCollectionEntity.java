...
public class JiankangyizhanCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiankangyizhanCollectionEntity() {

	}

	public JiankangyizhanCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "JiankangyizhanCollection{" +
            ", id=" + id +
