...
public class TijianYuyueView extends TijianYuyueEntity implements Serializable {
	...
	*/
	...
	private String tijianYuyueYesnoValue;
	...
	* 获取： 预约状态的值
	*/
	public String getTijianYuyueYesnoValue() {
		return tijianYuyueYesnoValue;
	}
	/**
	* 设置： 预约状态的值
	*/
	public void setTijianYuyueYesnoValue(String tijianYuyueYesnoValue) {
		this.tijianYuyueYesnoValue = tijianYuyueYesnoValue;
	}
	...
	public String toString() {
		return "TijianYuyueView{" +
			", tijianYuyueYesnoValue=" + tijianYuyueYesnoValue +
