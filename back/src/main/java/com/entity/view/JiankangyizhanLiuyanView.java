...
public class JiankangyizhanLiuyanView extends JiankangyizhanLiuyanEntity implements Serializable {
	...
	public JiankangyizhanLiuyanView() {

	}

	public JiankangyizhanLiuyanView(JiankangyizhanLiuyanEntity jiankangyizhanLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, jiankangyizhanLiuyanEntity);
	...
	public String toString() {
		return "JiankangyizhanLiuyanView{" +
