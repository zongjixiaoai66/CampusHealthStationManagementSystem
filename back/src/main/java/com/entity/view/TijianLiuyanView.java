...
public class TijianLiuyanView extends TijianLiuyanEntity implements Serializable {
	...
	public TijianLiuyanView() {

	}

	public TijianLiuyanView(TijianLiuyanEntity tijianLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, tijianLiuyanEntity);
